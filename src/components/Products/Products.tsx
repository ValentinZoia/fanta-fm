          ...
          ProductsData.map((item) =>(
            ...
            >
              <img 
                src={item.image}
                alt=""
                className="cursor-pointer  w-[100px] mb-4 hover:rotate-12 hover:scale-110 duration-300"
              />
              <div className="text-center space-y-2">
                ...
                <button className=" cursor-pointer !mt-5 border-2 border-primary text-primary px-6 py-2 rounded-md hover:bg-primary hover:text-white duration-200">
                  Buy Now
                </button>
